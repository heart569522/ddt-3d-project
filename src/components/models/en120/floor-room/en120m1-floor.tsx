...
Command: npx gltfjsx@6.5.2 ./public/models/building/en120/en120-m1.glb -t -k -E -R -f 
*/
"use client"
...
import { useEN116M1Store, useEN120M1Store } from '@/stores/use-floor-store'
...
export const en120Floorsm1 = [
  "EN120M199", 
] as const;

export type EN120FloorM1 = typeof en120Floorsm1[number];
...
export default function EN120M1Floor(props: Props) {
  const {
    isShowLamp,
    isShowAir,
    isManage,
  ...
  const { nodes, materials } = useGLTF('/models/building/en120/en120-m1.glb') as GLTFResult

  const [hover, setHover] = useState<EN120FloorM1 | null>(null);
  const { select, setSelect } = useEN120M1Store(state => (state));
  ...
  const handleObjectHover = useCallback((object: EN120FloorM1 | null | any) => {
    setHover(object);
  }, []);

  const handleObjectSelect = useCallback(
    (object: EN120FloorM1 | null | any) => {
      setSelect(object);
    },
    [setSelect]
  );
  ...
  return (
    <group 
      ...
      dispose={null}
    >
      <Select name="EN120M199" enabled={hover === "EN120M199" || select === "EN120M199"} position={[5.929, 0.961, 1.307]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={0.305}>
        {!isManage && !isRoomPage && renderModalDetail("EN120M199")}
        {!isManage && isRoomPage && renderModalRoomDetail("EN120M199")}
        <mesh name="EN1200399" geometry={nodes.EN1200399.geometry} material={materials['Default Wall']} />
        <mesh name="EN1200399_1" geometry={nodes.EN1200399_1.geometry} material={materials.ปูนฉาบ} />
        <mesh name="EN1200399_2" geometry={nodes.EN1200399_2.geometry} material={materials.กระเบื้องดินเผา} />
        <mesh name="EN1200399_3" geometry={nodes.EN1200399_3.geometry} material={materials.กระเบื้องเคลือบสี} />
        <mesh name="EN1200399_4" geometry={nodes.EN1200399_4.geometry} material={materials['Concrete, Cast-in-Place gray']} />
        <mesh name="EN1200399_5" geometry={nodes.EN1200399_5.geometry} material={materials['Concrete - Cast-in-Place Concrete - Concr_240 ksc']} />
      </Select>
...
useGLTF.preload('/models/building/en120/en120-m1.glb')
